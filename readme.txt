...
Major Functions: 
1.	Book searcher: users can enter the name of a book and will be redirected to the information page, where they can find info about the book and recommendations based on that book (using TasteDive API).
2.	User account creation: users can create accounts, log in and save the books they want to read.
3.	Books genres search: users can choose a book genre and explore the options to choose their next reading.
4.	Books lists: the users can create lists of books based on their preferences.
5.	Quotes generator: it generates a random quote and the user can click the button to generate a different one.
...
7.	Responsive Design: the application will be fullt responsive, adapting to different screen sizes.
